...
#    totalDown #comment this line if you have DHT sensor connected to RPi
#   totalUp #comment this line if you have DHT sensor connected to RPi
#    req = re.findall('\d+', str(msg.payload))[0]
#    

#    msg2 = '{{"Req": {},"Time": "{}","ID": {},"Td":{:1}, "Tu":{:1}}}'.format(req, timestamp, id, totalDown, totalUp)
    
#    client.publish("PeopleCount_data", msg2)
#    print(msg2)
...
while True:
	...
	if(elapsed > 30):
                ...
                msg2 = '{{"Time": "{}", "Td":{:1}, "Tu":{:1}}}'.format(timestamp, totalDown, totalUp)
                client.publish("PeopleCount_Data", msg2)
                start = datetime.datetime.now().timestamp()
